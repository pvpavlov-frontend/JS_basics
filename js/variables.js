...
if (userSumBuy > 800) {
  console.log( "сумма покупки с учетом 5% скидки = ", userSumBuy - userSumBuy * 5 / 100);
} else if (userSumBuy > 500) {
    console.log( "сумма покупки с учетом 3% скидки = ", userSumBuy - userSumBuy * 3 / 100);
} else {
    console.log("У Вас нет скидки!", "Cумма покупки с учетом скидки = " + userSumBuy + "грн.");
}
